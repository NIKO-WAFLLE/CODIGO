...
public class timetags : MonoBehaviour
{
    ...
    public Canvas worldSpaceCanvas; // El Canvas de tipo World Space que se activará/desactivará
    ...
    void Start()
    {
        // Asegurarnos de que el Canvas y el Empty estén desactivados al inicio
        if (emptyObject != null)
    ...
    void ActivateObjects(bool activate)
    {
        ...
        if (worldSpaceCanvas != null)
            worldSpaceCanvas.gameObject.SetActive(activate);
    }
}